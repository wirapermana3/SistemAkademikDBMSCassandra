...
<head>
  ...
  <title>SIACA - Ubah Data Mahasiswa</title>
            ...
            <div class="panel-body">
              ...
              <form class="form-horizontal" method="POST" action="proses_ubah.php">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="tempat_lahir" autocomplete="off" value="<?php echo $row["tempat_lahir"] ?>" required>
                  </div>
                </div>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="tanggal_lahir" value="<?= $row['tanggal_lahir'] ->toDateTime()->format("d-m-Y") ?>"autocomplete="off" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="no_telepon" value="<?= $row['no_telepon'] ?>" autocomplete="off" maxlength="13" onKeyPress="return goodchars(event,'0123456789',this)" value="" required>
                  </div>
                </div>
