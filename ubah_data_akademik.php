...
<head>
  ...
  <title>SIACA - Ubah Data Akademik Mahasiswa</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Ubah Data Akademik Mahasiswa</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="admin.php">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="akademik.php">Data Akademik Mahasiswa</a></li>
              <li class="breadcrumb-item active">Ubah Data Akademik Mahasiswa</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-body">
              ...
              ?>
              <form class="form-horizontal" method="POST" action="proses_ubah_akademik.php">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="nama" autocomplete="off" value="<?php echo $row["nama"] ?>" readonly>
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control" name="kelas" placeholder="Pilih Kelas" required>
                      <option disabled>--Data Sebelumnya--</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control" name="sts_smt" placeholder="Pilih Semester">
                      <option disabled>--Data Sebelumnya--</option>
                      <option value="<?php echo $row['sts_smt']; ?>"><?php echo $row['sts_smt']; ?></option>
                      <option disabled>--Pilih Salah Satu--</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="dos_akdmk" autocomplete="off" value="<?php echo $row["dos_akdmk"] ?>" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="number" class="form-control" min="0" max="200" name="sks_total" autocomplete="off" value="<?php echo $row["sks_total"] ?>" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="number" class="form-control" min="0" max="24" name="sks_now" autocomplete="off" value="<?php echo $row["sks_now"] ?>" required>
                  </div>
                </div>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control" name="sts_now" placeholder="Pilih Status">
                      <option disabled>--Data Sebelumnya--</option>
                      <option value="<?php echo $row['sts_now']; ?>"><?php echo $row['sts_now']; ?></option>
                      <option disabled>--Pilih Salah Satu--</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="number" placeholder="0.00" step="0.01" min="0.00" max="4.00" class="form-control" value="<?= $row['nilai_ipk'] ?>" name="nilai_ipk" autocomplete="off" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a href="akademik.php" class="btn btn-default btn-reset">Batal</a>
                  </div>
                </div>
              </form>
              <?php
