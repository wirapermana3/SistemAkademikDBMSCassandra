...
<head>
  ...
  <title>SIACA - Data Mahasiswa</title>
              ...
              <?php  
                if (empty($_GET['alert'])) {
                  ...
                  echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                        <strong>Sukses!</strong> Data Mahasiswa berhasil disimpan.
                        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                          <span aria-hidden='true'>&times;</span>
                        </button>
                      </div>";
                ...
                ?>
                  ...
                  <tr>
                      ...
                      <th><center>Edit Data Mahasiswa</center></th>
                  ...
                  // Tampilkan semua data
                    ...
                    <tr>
                      ...
                      <td><?= $row['semester'] ?></td>
                      <td><?= $row['nilai_ipk'] ?></td>-->
                      <td><center><a type="button" class="btn btn-primary" href="ubah_data_mahasiswa.php?nim=<?php echo $row['nim']; ?>">Ubah</a></center></td>
                      <td><center><a type="button" class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus data mahasiswa ini?')" href="proses_hapus.php?nim=<?php echo $row['nim']; ?>">Hapus</a></center></td>
                    </tr>
                    <?php
                    }
                  ?> 
