            ...
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary" href="tambah_data_mahasiswa.php">
                  <i class="fa fa-plus"></i>  <b>Tambah Data Mahasiswa dan Akademik</b>
                </a>
              </div>
              <div class="card-body">
              ...
              <?php  
                if (empty($_GET['alert'])) {
                  ...
                  echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                        <strong>Sukses!</strong> Data Akademik Mahasiswa berhasil disimpan.
                        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                          <span aria-hidden='true'>&times;</span>
                        </button>
                      </div>";
                  ...
                  echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                        <strong>Sukses!</strong> Data Mahasiswa berhasil dihapus.
                        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                          <span aria-hidden='true'>&times;</span>
                        </button>
                      </div>";
                ...
                ?>
                  ...
                  <tr>
                      ...
                      <th><center>Status Mahasiswa Saat Ini</center></th>
                      <th><center>IPK</center></th>
                      <th><center>Edit Data Akademik</center></th>
                      <th><center>Hapus Data Mahasiswa</center></th>
                  </tr>
                  </thead>
                  <tbody>
                  <?php
                  // Tampilkan semua data
                    ...
                    <tr>
                      ...
                      <td><?= $row['sts_now'] ?> </td>
                      <td><?= $row['nilai_ipk'] ?></td>
                      <td><center><a type="button" class="btn btn-primary" href="ubah_data_akademik.php?nim=<?php echo $row['nim']; ?>">Ubah</a></center></td>
                      <td><center><a type="button" class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus data mahasiswa ini?')" href="proses_hapus_2.php?nim=<?php echo $row['nim']; ?>">Hapus</a></center></td>
                    </tr>
                    <?php
                    }
                  ?> 
