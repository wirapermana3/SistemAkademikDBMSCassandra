...
<head>
  ...
  <title>SIACA - Data IPK Mahasiswa</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Data IPK Mahasiswa</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  // Tampilkan semua data
                    ...
                    <tr>
                      ...
                      <td><center><a class = "btn-dark btn-sm" href="user_3.php?nim=<?php echo $row['nim']; ?>"><?= $row['nim'] ?></a></center></td>
                      <td><?= $row['nama'] ?></td>
                      <!--<td><?= $row['kelas'] ?></td>
                      <td><?= $row['semester'] ?></td>-->
                      <td><?= $row['nilai_ipk'] ?></td>
